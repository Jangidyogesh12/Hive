...
/// Tabular result produced by query execution.
///
/// Empty `columns` means the query completed without a returned projection, as
/// with `CREATE`, `SET`, or `DELETE` statements.
